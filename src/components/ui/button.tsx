  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-primary-foreground shadow-medium hover:shadow-large scale-100 hover:scale-105 transition-bounce",
        cart: "bg-accent text-accent-foreground hover:bg-accent-soft shadow-medium font-semibold",
        premium: "gradient-primary text-primary-foreground shadow-large hover:shadow-large font-semibold tracking-wide",
      },
      size: {
